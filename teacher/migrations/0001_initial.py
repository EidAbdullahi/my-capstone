    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_designation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='administration.Designation')),
            ],
        ),
        migrations.CreateModel(
            name='TrainingInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.CharField(choices=[('Kenya', 'Kenya'), ('Others', 'Others')], max_length=45)),
