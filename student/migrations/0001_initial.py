    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.CharField(choices=[('Kenya', 'Kenyan'), ('', 'Others')], max_length=45)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('registration_no', models.IntegerField(default=110701, unique=True)),
                ...
                ('guardian_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.GuardianInfo')),
